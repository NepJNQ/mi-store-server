...
/*
 * @Description: 校验用户注册信息格式
 * @Author: Nep
 * @Date: 2020-12-18 16:24:12
 * @LastEditTime: 2020-12-23 20:31:29
 */
module.exports = {
  /**
   * @description: 登录校验
  ...
  checkUserInfo: (username = "", password = "") => {
    if (!username.length || !password.length)
      throw new ApiError(ApiErrorNames.ILLEGAL_FORMAT, "用户名和密码不能为空");
    // 校验规则
